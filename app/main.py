...
app=FastAPI(title='Crypto AI Multi-Agent',version='0.4.0',description='Private AI financial office with broker configuration, reports, team management and Owner governance.')
...
@app.get('/')
def root(): return {'name':'Crypto AI Multi-Agent','status':'online','version':'0.4.0','dashboard':'/dashboard','docs':'/docs','health':'/health'}
@app.get('/health')
